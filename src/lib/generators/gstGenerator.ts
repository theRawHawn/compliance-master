...
export function generateGstr3bExcel(
  ...
  const tableData = [
    ...
    ['IGST', summary.grossOutwardTaxForLiability.integratedTax, summary.table4_EligibleITC.a5_allOtherITC.integratedTax, summary.netTaxPayable.integratedTax, summary.excessItcCarriedForward.integratedTax],
    ['CGST', summary.grossOutwardTaxForLiability.centralTax, summary.table4_EligibleITC.a5_allOtherITC.centralTax, summary.netTaxPayable.centralTax, summary.excessItcCarriedForward.centralTax],
    ['SGST', summary.grossOutwardTaxForLiability.stateTax, summary.table4_EligibleITC.a5_allOtherITC.stateTax, summary.netTaxPayable.stateTax, summary.excessItcCarriedForward.stateTax],
    ['Cess', summary.grossOutwardTaxForLiability.cess, summary.table4_EligibleITC.a5_allOtherITC.cess, summary.netTaxPayable.cess, summary.excessItcCarriedForward.cess],
